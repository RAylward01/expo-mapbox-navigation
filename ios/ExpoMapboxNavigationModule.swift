...
public class ExpoMapboxNavigationModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    View(ExpoMapboxNavigationView.self) {
      ...
      Prop("force2D") { (view: ExpoMapboxNavigationView, force2D: Bool?) in
        view.controller.setForce2D(force2D: force2D)
      }
      
      Prop("useMetricUnits") { (view: ExpoMapboxNavigationView, useMetric: Bool?) in
        view.controller.setUseMetricUnits(useMetric: useMetric)
      }
